export default ({ name }: { name: string }) => ({
  subject: "Your Cold Asset Account Has Been Restored",
  html: `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px; background-color:#FFFFFF; border-radius:14px; padding:32px;">
          ...
          <tr>
            <td style="font-size:16px; line-height:1.6; padding-bottom:16px;">
              We’re pleased to inform you that your Cold Asset account has been successfully restored following our review.
            </td>
          </tr>

          <tr>
            <td style="font-size:16px; line-height:1.6; padding-bottom:20px;">
              You now have full access to your account and can continue using all Cold Asset services without restriction.
            </td>
          </tr>
