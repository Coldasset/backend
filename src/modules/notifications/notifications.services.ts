...
export const createNotification = async (user: string, input: CreateNotificationInput) => {
...
export const isNotificationOwnedByUser = async (notificationId: string, user: string): Promise<boolean> => {
