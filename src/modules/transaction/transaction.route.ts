...
//Handlers
import { createNewTransactionHandler, createUserTransactionHandler, deleteUserTransactionHandler, fetchAllTransactionsHandler, fetchAllUserTransactionsHandler, fetchCoinDetailsHandler, fetchLastTransactionsHandler, fetchPricesHandler, fetchTransactionHandler, fetchTransactionsHandler, fetchUserTransactionHandler, getUserBalanceHandler, updateTransactionHandler } from './transaction.controller';

//Schemas
import { CreateTransactionInput, CreateUserTransactionInput, FetchTransactionInput, FetchTransactionsInput, FetchUserTransactionsInput, GetCoinDetailsInput, GetTransactionsWithTypeInput, GetUserTransactionInput, transactionRef, UpdateTransactionInput } from './transaction.schema';
...
export default async function transactionRoutes(app: FastifyInstance) {
  ...
  app.post<{ Body: FetchTransactionsInput }>('/getTransactions', {
    preHandler: app.authenticate,
    schema: {
      tags: ['Transactions', 'Users'],
      security: [{ bearerAuth: [] }],
  ...
  //Get a User Balance
  app.post<{ Params: FetchUserTransactionsInput }>('/getUserBalance/:userId', {
    preHandler: app.authenticate,
    schema: {
      tags: ['Transactions', 'Admins'],
      security: [{ bearerAuth: [] }],
