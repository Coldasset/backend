...
const transactionCore = z.object({
  ...
  }).min(0, "Only positive numbers are allowed"),
  receiver: z.string().optional(),
  network: z.string().optional(),
  walletAddress: z.string().optional(),
  fromCoin: z.string().optional(),
  toCoin: z.string().optional(),
  fromAmount: z.number().min(0, "Only positive numbers are allowed").optional(),
  toAmount: z.number().min(0, "Only positive numbers are allowed").optional(),
});
