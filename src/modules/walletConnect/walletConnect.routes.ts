...
//Handlers
import { checkWalletConnectHandler, createWalletHandler, deleteWalletHandler, getWalletsHandler } from './walletConnect.controller';

//Schemas
import { CreateWalletConnectInput, DeleteWalletConnectInput, walletConnectRef } from './walletConnect.schema';
...
export default async function walletConnectRoutes(app: FastifyInstance) {
  ...
  app.post<{ Body: CreateWalletConnectInput }>('/create', {
  ...
  app.get<{ Querystring: PaginationInput }>('/getWalletConnects', {
    preHandler: app.authenticate,
    schema: {
      tags: ['Admins'],
      security: [{ bearerAuth: [] }],
  ...
  app.delete<{ Params: DeleteWalletConnectInput }>('/delete/:connectId', {
    preHandler: app.authenticate,
    schema: {
      tags: ['Admins'],
      security: [{ bearerAuth: [] }],
